...
const workshopFeedbackSchema = new mongoose.Schema({
  ...
  trainerRating: { type: Number, min: 1, max: 5, default: 0 },
  contentRating: { type: Number, min: 1, max: 5, default: 0 },
  audioRating:   { type: Number, min: 1, max: 5, default: 0 },
  videoRating:   { type: Number, min: 1, max: 5, default: 0 },
